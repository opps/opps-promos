...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Promo.banner'
        db.add_column(u'promos_promo', 'banner',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='promo_banner', null=True, on_delete=models.SET_NULL, to=orm['images.Image']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Promo.banner'
        db.delete_column(u'promos_promo', 'banner_id')
