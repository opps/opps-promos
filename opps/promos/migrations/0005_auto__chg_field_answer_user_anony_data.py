...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Answer.user_anony_data'
        db.alter_column(u'promos_answer', 'user_anony_data', self.gf('opps.db.models.fields.jsonf.JSONField')())

    def backwards(self, orm):

        # Changing field 'Answer.user_anony_data'
        db.alter_column(u'promos_answer', 'user_anony_data', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        u'promos.answer': {
            ...
            'user_anony_data': ('opps.db.models.fields.jsonf.JSONField', [], {'blank': 'True'})
        },
        u'promos.promo': {
