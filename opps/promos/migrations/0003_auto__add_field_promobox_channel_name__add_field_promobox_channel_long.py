...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PromoBox.channel_name'
        db.add_column(u'promos_promobox', 'channel_name',
                      self.gf('django.db.models.fields.CharField')(max_length=140, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'PromoBox.channel_long_slug'
        db.add_column(u'promos_promobox', 'channel_long_slug',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PromoBox.channel_name'
        db.delete_column(u'promos_promobox', 'channel_name')

        # Deleting field 'PromoBox.channel_long_slug'
        db.delete_column(u'promos_promobox', 'channel_long_slug')
