...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'promos_promo', (
            ...
            ('main_image', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='promo_image', null=True, on_delete=models.SET_NULL, to=orm['images.Image'])),
            ('date_end', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('order', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('has_upload', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('has_urlfield', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ...
        # Adding model 'PromoPost'
        db.create_table(u'promos_promopost', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('post', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='promopost_post', null=True, on_delete=models.SET_NULL, to=orm['articles.Post'])),
        ...
        db.send_create_signal(u'promos', ['PromoPost'])
        ...
        db.create_table(u'promos_promobox', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date_insert', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('date_update', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm["%s.%s" % (User._meta.app_label, User._meta.object_name)])),
        ...
        db.send_create_signal(u'promos', ['PromoBox'])

        # Adding model 'PromoBoxPromos'
        db.create_table(u'promos_promoboxpromos', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('promobox', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='promoboxpromos_promoboxes', null=True, on_delete=models.SET_NULL, to=orm['promos.PromoBox'])),
            ('promo', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='promoboxpromos_promos', null=True, on_delete=models.SET_NULL, to=orm['promos.Promo'])),
            ('order', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
        ))
        db.send_create_signal(u'promos', ['PromoBoxPromos'])

        # Adding model 'PromoConfig'
        db.create_table(u'promos_promoconfig', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date_insert', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('date_update', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm["%s.%s" % (User._meta.app_label, User._meta.object_name)])),
            ...
            ('article', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['articles.Article'], null=True, on_delete=models.SET_NULL, blank=True)),
            ('channel', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['channels.Channel'], null=True, on_delete=models.SET_NULL, blank=True)),
            ('promo', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='promoconfig_promos', null=True, on_delete=models.SET_NULL, to=orm['promos.Promo'])),
        ))
        db.send_create_signal(u'promos', ['PromoConfig'])

        # Adding unique constraint on 'PromoConfig', fields ['key_group', 'key', 'site', 'channel', 'article', 'promo']
        db.create_unique(u'promos_promoconfig', ['key_group', 'key', 'site_id', 'channel_id', 'article_id', 'promo_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'PromoConfig', fields ['key_group', 'key', 'site', 'channel', 'article', 'promo']
        db.delete_unique(u'promos_promoconfig', ['key_group', 'key', 'site_id', 'channel_id', 'article_id', 'promo_id'])

        # Deleting model 'Promo'
        db.delete_table(u'promos_promo')

        # Deleting model 'PromoPost'
        db.delete_table(u'promos_promopost')

        # Deleting model 'Answer'
        db.delete_table(u'promos_answer')

        # Deleting model 'PromoBox'
        db.delete_table(u'promos_promobox')

        # Deleting model 'PromoBoxPromos'
        db.delete_table(u'promos_promoboxpromos')

        # Deleting model 'PromoConfig'
        db.delete_table(u'promos_promoconfig')
    ...
    models = {
        ...
        u'promos.promo': {
            'Meta': {'ordering': "['order']", 'object_name': 'Promo'},
        ...
        u'promos.promoboxpromos': {
            'Meta': {'object_name': 'PromoBoxPromos'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
