...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Promo.has_upload'
        db.delete_column(u'promos_promo', 'has_upload')

        # Deleting field 'Promo.has_urlfield'
        db.delete_column(u'promos_promo', 'has_urlfield')

        # Adding field 'Promo.form_type'
        db.add_column(u'promos_promo', 'form_type',
                      self.gf('django.db.models.fields.CharField')(default='text', max_length=20),
                      keep_default=False)

        # Adding index on 'Promo', fields ['date_available']
        db.create_index(u'promos_promo', ['date_available'])

        # Adding index on 'Promo', fields ['published']
        db.create_index(u'promos_promo', ['published'])

        # Adding index on 'PromoConfig', fields ['date_available']
        db.create_index(u'promos_promoconfig', ['date_available'])

        # Adding index on 'PromoConfig', fields ['published']
        db.create_index(u'promos_promoconfig', ['published'])

        # Adding index on 'PromoBox', fields ['date_available']
        db.create_index(u'promos_promobox', ['date_available'])

        # Adding index on 'PromoBox', fields ['published']
        db.create_index(u'promos_promobox', ['published'])


    def backwards(self, orm):
        # Removing index on 'PromoBox', fields ['published']
        db.delete_index(u'promos_promobox', ['published'])

        # Removing index on 'PromoBox', fields ['date_available']
        db.delete_index(u'promos_promobox', ['date_available'])

        # Removing index on 'PromoConfig', fields ['published']
        db.delete_index(u'promos_promoconfig', ['published'])

        # Removing index on 'PromoConfig', fields ['date_available']
        db.delete_index(u'promos_promoconfig', ['date_available'])

        # Removing index on 'Promo', fields ['published']
        db.delete_index(u'promos_promo', ['published'])

        # Removing index on 'Promo', fields ['date_available']
        db.delete_index(u'promos_promo', ['date_available'])

        # Adding field 'Promo.has_upload'
        db.add_column(u'promos_promo', 'has_upload',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Promo.has_urlfield'
        db.add_column(u'promos_promo', 'has_urlfield',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Promo.form_type'
        db.delete_column(u'promos_promo', 'form_type')
