...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Promo', fields ['slug']
        db.delete_unique(u'promos_promo', ['slug'])

        # Adding field 'PromoBoxPromos.date_available'
        db.add_column(u'promos_promoboxpromos', 'date_available',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, null=True),
                      keep_default=False)

        # Adding field 'PromoBoxPromos.date_end'
        db.add_column(u'promos_promoboxpromos', 'date_end',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding unique constraint on 'Promo', fields ['slug']
        db.create_unique(u'promos_promo', ['slug'])

        # Deleting field 'PromoBoxPromos.date_available'
        db.delete_column(u'promos_promoboxpromos', 'date_available')

        # Deleting field 'PromoBoxPromos.date_end'
        db.delete_column(u'promos_promoboxpromos', 'date_end')
